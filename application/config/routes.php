...
$route['admin/data-pendaftar/:any/ubah']['GET'] = 'Admin_Controller/get_ubah_pendaftar';
$route['admin/data-pendaftar/:any/ubah']['POST'] = 'Admin_Controller/post_ubah_pendaftar';
$route['admin/data-pendaftar/(pmdp|ktmse|pmdp-ktmse)/:any/hapus'] = 'Admin_Controller/hapus_pendaftar';
