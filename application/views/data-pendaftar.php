...
<body>
    ...
    <div class="block"></div>
        ...
        <main>
            ...
            <div class="actions">
                <div class="search">
                    <form action="cari-pendaftar" method="GET">
						<input type="hidden" name="search_jalur" id="search_jalur" value="<?= $this->input->get('jalur') ?>">
                        ...
                        <input type="text" class="search-text" name="search_keyword" placeholder="Cari data pendaftar ...">
                    ...
                    <tbody>
                        <?php foreach ($data_pendaftar as $key => $data): ?>
                            <tr>
                                ...
                                <td class="mw-150"><a class="btn-action btn-primary" href="data-pendaftar/detail/<?= $data['nisn'] ?>">Lihat Detail</a></td>
                                <td class="mw-150"><a class="btn-action btn-primary" href="data-pendaftar/ubah/<?= $data['nisn'] ?>">Ubah</a></td>
                                <td class="mw-150"><a class="btn-action btn-danger hapus-data" id="data-pendaftar/hapus/<?= $data['nisn'] ?>?jalur=<?= $this->input->get('jalur') ?> <?= $data['nama_lengkap'] ?>">Hapus</a></td>
                            </tr>
                            <?php $counter++; ?>
                        <?php endforeach; ?>
                    </tbody>
