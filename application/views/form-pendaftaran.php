<div class="container">
	...
	<main>
    	<div class="form-data">
			...
			<div class="form">
				<form action="<?= base_url() ?>Daftar_Controller/post_form_pendaftaran/<?= $segment ?>" method="POST" enctype="multipart/form-data">
					<!-- <?= validation_errors() ?> -->
					...
					<div class="table-form siswa active" id="siswa">
						...
						<div class="btn-page">
							<a class="a-btn btn-primary btn-page" href="<?= base_url() ?>">Kembali</a>
					...
					<div class="table-form berkas" id="berkas">
						...
						<p>Peserta yang mendaftar pada Sipenmaru Jalur KTMSE/GAKIN Tidak diperbolehkan Mendaftar Pada Sipenmaru Jalur PMDP ataupun sebaliknya.</p>
						<div class="paragraph">
